	...
	class NasWP_Lightbox
	{
		...
		public function load_assets()
		{
			if (has_block('core/image') || has_block('core/gallery')) {
				wp_enqueue_style('baguette', get_stylesheet_directory_uri() . '/library/css-lib/baguetteBox.min.css');
				wp_enqueue_script('baguette', get_stylesheet_directory_uri() . '/library/js/libs/baguetteBox.combined.js', array('jquery'), '1.11.1', true);
			}
		}
		...
		public function load_editor_assets()
		{
			wp_enqueue_script(
				'baguette',
				get_stylesheet_directory_uri() . '/library/js/libs/baguetteBox.admin.js',
